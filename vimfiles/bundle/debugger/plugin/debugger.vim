...
elseif filereadable($VIM."/debugger.py")
  pyfile $VIM/debugger.py
elseif filereadable($HOME."/.vim/debugger.py")
  pyfile $HOME/.vim/debugger.py
else
...
command! -nargs=0 D call <SID>Map_Debug_Key()
